    ...
    <div className="relative bg-surface-container-low p-3 rounded-xl shadow-[0_8px_30px_rgba(0,0,0,0.4)] border border-outline-variant/20 w-64 transition-all duration-300 hover:border-tertiary/30">
      ...
      <div className="flex items-center gap-2 mb-2">
        <div className="p-1 bg-tertiary-container/30 rounded flex items-center justify-center">
          {isLoading ? (
            <Loader2 size={12} className="text-tertiary animate-spin" />
          ) : (
      ...
      {/* Output Area */}
      <div className="bg-surface-container-high/50 border border-outline-variant/30 rounded-lg min-h-16 px-2.5 py-1.5 flex items-center">
        {isLoading ? (
          <p className="text-tertiary/80 text-xs italic animate-pulse w-full">
            Thinking...
          </p>
        ) : (
